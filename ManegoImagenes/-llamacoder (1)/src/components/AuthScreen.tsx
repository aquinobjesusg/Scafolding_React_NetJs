      ...
      <div className="w-full max-w-5xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-teal-900">Administracion de Productos</h1>
              <p className="text-sm text-teal-600">Geestion de Productos</p>
            </div>
          </div>
          <h2 className="text-4xl font-bold text-teal-900 leading-tight mb-4">
            Gestión de productos
            <br />
            <span className="text-teal-600">para tu clientes</span>
          </h2>
          <p className="text-teal-700/80 text-lg mb-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <div key={label} className="bg-white/60 backdrop-blur rounded-xl p-4 border border-teal-100">
        ...
        <Card className="shadow-2xl shadow-teal-200/50 border-teal-100">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-teal-900 text-center">
              Bienvenido
            </CardTitle>
          ...
          <CardContent>
            <Tabs defaultValue="login" className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-6 bg-teal-50">
              ...
              <TabsContent value="login" className="space-y-4">
                <form onSubmit={handleEmailLogin} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-teal-900">Correo electrónico</Label>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="password" className="text-teal-900">Contraseña</Label>
                      <button
                        type="button"
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-white px-2 text-teal-600">O continúa con</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button
                    variant="outline"
                    className="border-teal-200 hover:bg-teal-50 text-teal-900"
              ...
              <TabsContent value="register" className="space-y-4">
                <form onSubmit={handleRegister} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-teal-900">Nombre completo</Label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="reg-email" className="text-teal-900">Correo electrónico</Label>
                    <div className="relative">
                      <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-teal-500" />
                      <Input
                        id="reg-email"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="reg-password" className="text-teal-900">Contraseña</Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-teal-500" />
                      <Input
                        id="reg-password"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="confirm-password" className="text-teal-900">Confirmar contraseña</Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-teal-500" />
                      <Input
                        id="confirm-password"

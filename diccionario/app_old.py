...
<body>
    ...
    <script>
        ...
        async function recuperar() {
            ...
            try {
                const response = await fetch('http://127.0.0.1:5000/api/recuperar', {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
...
<body>
    ...
    <script>
        ...
        async function crearPassword() {
            ...
            try {
                const response = await fetch('http://127.0.0.1:5000/api/crear-password', {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
                    body: JSON.stringify({
                        token: token,
...
//            alert( document.getElementById('categoria').value );
        ...
        async function cargarDatos() {
            ...
            try {
                const response = await fetch('http://127.0.0.1:5000/api/cargar-datos', {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
                    body: JSON.stringify(data)
                });

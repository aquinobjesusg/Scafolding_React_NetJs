# http://127.0.0.1:5000/
# https://systemsya.com/diccionario/
...
def ejecutar_envio_mail(destino, asunto, cuerpo):
    ...
    try:
        print('antes smtp')
        server = smtplib.SMTP('mail.systemsya.com', 465)
...
Este enlace es de un solo uso."""
        ...
        print(asunto)
        print(cuerpo)
        print(ejecutar_envio_mail(correo, asunto, cuerpo))
...
<body>
    ...
    <script>
        ...
        async function login() {
            ...
            try {
                const response = await fetch('https://systemsya.com/diccionario/api/login', {
                    method: 'POST',
                ...
                if (data.success) {
                    window.location.href = 'https://systemsya.com/diccionario/dashboard';
                } else {
        ...
        async function registro() {
            ...
            try {
                const response = await fetch('https://systemsya.com/diccionario/api/registro', {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
        ...
        async function recuperar() {
            ...
            try {
                const response = await fetch('https://systemsya.com/diccionario/api/recuperar', {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
...
<body>
    ...
    <script>
        ...
        async function crearPassword() {
            ...
            try {
                const response = await fetch('https://systemsya.com/diccionario/api/crear-password', {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
                    body: JSON.stringify({
                        token: token,
...
//            alert( document.getElementById('categoria').value );
        ...
        async function logout() {
            await fetch('https://systemsya.com/diccionario/api/logout', { method: 'POST' });

...
export const DashboardOverview: React.FC<DashboardOverviewProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Welcome banner with warm amber/orange gradient */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between rounded-2xl bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 p-6 text-white shadow-md">
        <div className="space-y-1">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-white/20 px-2.5 py-0.5 text-xs font-semibold text-white">
        ...
        <div className="mt-4 sm:mt-0 flex flex-wrap items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl bg-white text-orange-700 hover:bg-orange-50 px-3.5 py-2 text-xs font-bold shadow-sm transition-all"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl bg-orange-700/60 hover:bg-orange-700 border border-orange-400 px-3.5 py-2 text-xs font-bold text-white transition-all"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* KPI 1 */}
        <div className="rounded-2xl border border-orange-100 bg-white p-4 shadow-2xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 rounded-2xl border border-orange-100 bg-white p-5 shadow-2xs space-y-4">
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-orange-100 bg-white p-5 shadow-2xs space-y-3">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full flex items-center justify-between rounded-xl border border-gray-100 bg-gray-50/70 p-3 text-left hover:bg-orange-50 hover:border-orange-200 transition-colors"
              >
          ...
          <div className="rounded-2xl border border-orange-200 bg-orange-50/60 p-4">
            ...
            <p className="text-[11px] text-orange-700/80 mb-3">
            ...
            <button
              onClick={handleExportQuickStats}
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-white border border-orange-300 px-3 py-2 text-xs font-bold text-orange-700 hover:bg-orange-500 hover:text-white transition-colors"
            >
              <FileSpreadsheet className="h-4 w-4 text-emerald-600" />

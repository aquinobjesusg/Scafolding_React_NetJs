...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const handleForgot = (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      setEnteredToken(result.token || '');
      setMode('reset');
      setFeedback({ type: 'success', message: `${result.message} (Código Demo: ${result.token})` });
    } else {
      setFeedback({ type: 'error', message: result.message });
    }
  };
  ...
  const handleReset = (e: React.FormEvent) => {
    ...
    const result = resetPassword(email, enteredToken, newPassword);
    if (result.success) {
      setFeedback({ type: 'success', message: '¡Contraseña restablecida con éxito! Ya puedes ingresar.' });
      setMode('login');
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs">
      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="mb-5 rounded-xl bg-orange-50/60 p-3 border border-orange-100/70">
            ...
            <div className="grid grid-cols-3 gap-1.5">
              <button
                ...
                className="flex items-center justify-center gap-1 rounded-lg bg-white px-2 py-1.5 text-xs font-semibold text-orange-700 shadow-2xs hover:bg-orange-500 hover:text-white transition-colors"
              >
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-300 px-3.5 py-2.5 text-sm text-gray-900 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-hidden transition-all"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-300 px-3.5 py-2.5 text-sm text-gray-900 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-hidden transition-all pr-10"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                id="submit-login-btn"
                className="w-full flex items-center justify-center gap-2 rounded-xl bg-orange-500 py-3 text-sm font-semibold text-white shadow-md hover:bg-orange-600 active:scale-[0.99] transition-all"
              >
            ...
            <form onSubmit={handleRegister} className="space-y-3.5">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-300 px-3.5 py-2 text-sm text-gray-900 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-hidden"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    value={password}
                    onChange={(e) => setPassword(e.target.value)}
                    className="w-full rounded-xl border border-gray-300 px-3 py-2 text-sm text-gray-900 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-hidden"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium uppercase text-gray-700 mb-1">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 rounded-xl bg-orange-500 py-3 text-sm font-semibold text-white shadow-md hover:bg-orange-600 active:scale-[0.99] transition-all mt-2"
              >
          ...
          {mode === 'forgot' && (
            <form onSubmit={handleForgot} className="space-y-4">
              ...
              <button
                ...
                className="w-full rounded-xl bg-orange-500 py-2.5 text-sm font-semibold text-white shadow-md hover:bg-orange-600 transition-all"
              >
            ...
            <form onSubmit={handleReset} className="space-y-3.5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-center tracking-widest font-mono font-bold uppercase rounded-xl border border-gray-300 px-3 py-2 text-base text-gray-900 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-hidden"
                />
              </div>

        ...
        {completedTransaction ? (
          ...
          <div className="p-8 text-center space-y-4">
            ...
            <button
              ...
              className="w-full max-w-sm rounded-xl bg-orange-500 py-3 text-xs font-bold text-white shadow-md hover:bg-orange-600 transition-all"
            >
          ...
          <div className="p-6 space-y-5">
            {/* Course mini recap */}
            <div className="flex items-center gap-3 rounded-xl bg-orange-50/50 p-3 border border-orange-100/70">
              <img
                ...
                <button
                  ...
                  className={`flex flex-col items-center justify-center gap-1 rounded-xl border p-2.5 text-xs font-semibold transition-all ${
                    paymentMethod === 'Tarjeta de Crédito'
                      ? 'border-orange-500 bg-orange-50/50 text-orange-700 shadow-2xs font-bold'
              ...
              <div className="space-y-3 rounded-xl border border-gray-200 p-3.5 bg-gray-50/40">
                <div>
                  ...
                  <input
                    ...
                    className="w-full font-mono text-xs rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 focus:border-orange-500 outline-hidden"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 focus:border-orange-500 outline-hidden"
                    />
                  </div>
            ...
            <div className="rounded-xl border border-gray-100 bg-gray-50/70 p-3 text-xs space-y-1.5">
              ...
              <div className="flex justify-between font-extrabold text-gray-900 text-sm border-t border-gray-200 pt-1.5 mt-1.5">
                ...
                <span className="text-orange-600">${finalTotal.toFixed(2)} USD</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-orange-500 py-3 text-xs font-bold text-white shadow-md hover:bg-orange-600 disabled:opacity-50 transition-all active:scale-[0.99]"
            >
              {isProcessing ? (

    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 rounded-xl bg-gray-50 p-3 border border-gray-200/60">
          <img
            ...
            alt="Avatar"
            className="h-10 w-10 rounded-xl object-cover ring-1 ring-indigo-200"
          />
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <Icon className={`h-4 w-4 shrink-0 transition-transform ${isActive ? 'text-white' : 'text-gray-400 group-hover:text-gray-600'}`} />
      ...
      <div className="pt-4 border-t border-gray-100 space-y-2 mt-6">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-gray-200 px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50 transition-colors"
        >

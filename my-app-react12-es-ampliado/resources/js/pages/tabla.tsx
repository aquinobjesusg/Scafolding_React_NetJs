...
// En tabla.tsx - Importación correcta
import DynamicCrud from '@/components/DynamicCrud';
// O también (pero no recomendado)
//import { default as DynamicCrud } from '@/components/DynamicCrud';
...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Informacion Inicial', href: '/dashboard' }];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
          ...
          {/* <Card className="md:col-span-2 bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
            <CardHeader className="px-4 py-3">
              <CardTitle className="text-lg font-semibold text-gray-800 dark:text-white">Información</CardTitle>
            </CardHeader>

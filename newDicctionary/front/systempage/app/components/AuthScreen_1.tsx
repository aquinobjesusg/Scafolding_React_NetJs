...
<Select id="idioma"   items={items}>
  <SelectTrigger className="border-sky-700 bg-slate-800/60 pl-10 pr-10 text-sky-50 placeholder:text-sky-300/40 focus:border-sky-500">

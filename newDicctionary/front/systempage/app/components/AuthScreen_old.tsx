          ...
          {view === "login" && (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-sky-600 to-emerald-700 text-white shadow-lg hover:from-sky-500 hover:to-emerald-600"
                >
          ...
          {view === "register" && (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-emerald-600 to-teal-700 text-white shadow-lg hover:from-emerald-500 hover:to-teal-600"
                >
